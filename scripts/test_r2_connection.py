...
def test_r2_connection():
    ...
    try:
        ...
        if bucket_name not in buckets:
            print(f"\n⚠️  Warning: Bucket '{bucket_name}' not found!")
            print("   Please create the bucket in Cloudflare R2 Dashboard")
            return False

        # Test 2: Upload file
        print(f"\n📤 Test 2: Uploading test file to '{bucket_name}'...")
        ...
        print(f"✅ Upload successful: s3://{bucket_name}/{test_key}")
        ...
        # Test 4: List objects
        print(f"\n📋 Test 4: Listing objects in 'test/' prefix...")
        ...
        print(f"\n🔍 Test 5: Getting object metadata...")
        ...
        # Success!
        print("\n" + "=" * 60)
        print("✅ All tests passed! R2 connection is working properly.")
        print("=" * 60)
        print("\n📋 Next steps:")
