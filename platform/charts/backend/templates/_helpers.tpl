...
{{/*
User Database URL helper
*/}}
{{- define "backend.userDatabaseUrl" -}}
postgresql://{{ .Values.userPostgresql.username }}:$(USER_DATABASE_PASSWORD)@{{ .Values.userPostgresql.host }}:{{ .Values.userPostgresql.port }}/{{ .Values.userPostgresql.database }}
{{- end }}
