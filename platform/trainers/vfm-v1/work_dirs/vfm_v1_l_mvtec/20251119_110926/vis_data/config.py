...
coco_train_dataset = dict(
    ...
    dataset=dict(
        ann_file='train_annotations/annotations.json',
        data_prefix=dict(img='train_annotations/'),
        data_root='data/mvtec_v3/',
...
default_hooks = dict(
    checkpoint=dict(
        interval=20, max_keep_ckpts=-1, save_best=None, type='CheckpointHook'),
...
test_evaluator = dict(
    ann_file='data/mvtec_v3/val_annotations/annotations.json',
    classwise=True,
    metric='bbox',
    proposal_nums=(
        100,
...
weight_decay = 0.05
widen_factor = 1.0
work_dir = './work_dirs/vfm_v1_l_mvtec'
