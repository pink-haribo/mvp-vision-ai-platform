"""
VFM-v1 Default Config Template

This module provides the default MMEngine config template for VFM training.
...
def get_config_template(
    ...
    """
    Generate VFM MMEngine config content.
    ...
    """
    return f'''# Auto-generated VFM-v1 config for {model_name}
